# 📆 Relatório dia 30 - Definindo o futuro do projeto
- **Data:** 17/02/2026
- **Foco:** Planejamento de features

---

### ✅ O que eu fiz hoje:
#### 1. Fonte
- Mudei a fonte para uma mais agradável em pixel art, e que possui suporte à acentos;
- Ajustei o tamanho da fonte em cada cena, texto e botão, já que a anterior era bem maior que a atual;

#### 2. Novas features futuras
- **Tradução para inglês:** Vou usar o sistema nativo do Godot para ter a opção de jogar em inglês, ampliando a possibilidade de público e servindo como aprendizado;
